...
<footer className="footer bg-dark text-light" >
  ...
  <section className="bg-dark py-4 py-md-5 py-xl-8 border-top border-dark">
    <div className="container overflow-hidden">
      <div className="row gy-4 gy-lg-0 justify-content-xl-between">
        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
          ...
          <p>Welcome to the Shreehans Arts and Creations Pvt. Ltd. I am extremely proud the way our production house has risen- with flexibility and resilience.</p>
        </div>
        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
          <div className="widget">
            ...
            <p className="mb-1">
              <a className="link-secondary text-decoration-none text-light " href="tel:+15057922430">(505) 792-2430</a>
            </p>
            <p className="mb-0">
              <a className="link-secondary text-decoration-none text-light" href="mailto:demo@yourdomain.com">demo@yourdomain.com</a>
            </p>
          </div>
        </div>
        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
          <div className="widget">
            ...
            <ul className="list-unstyled">
                ...
                <a href="#!" className="link-secondary text-decoration-none text-light">{elem}</a>
              </li>
      ...
      <div className="row gy-4 gy-md-0 align-items-md-center">
        <div className="col-xs-12 col-md-7 order-1 order-md-0">
          ...
          <div className="credits text-secondary text-center text-md-start mt-2 fs-8">
            Built by <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">Untechy</a> with <span className="text-primary">♥</span>
          </div>
        </div>
