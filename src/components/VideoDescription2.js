        ...
        <div className='outer-div'>
          ...
          <div className='outer-div-content'>
            ...
            <ul>
              ...
              <li><span>Co-Producer  :</span>
                <span>{elem.coproducer}</span>
              </li>
              <li><span>Line Producer  :</span>
                <span>{elem.lineproducer}</span>
              </li>
              <li><span>Executive Producer  :</span>
                <span>{elem.executiveproducer}</span>
              </li>
              <li><span>Writer  :</span>
                <span>{elem.writer}</span>
              </li>
              <li><span>Mixing &amp; Mastering  :</span>
